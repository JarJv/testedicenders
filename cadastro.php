            ...
            <div class="position-absolute top-50 start-50 translate-middle" style="width: 30%;">
                <div class="card bg-glass text-2 mb-3 text-center">
                    <div class="card-body">
                        ...
                        <form id="form-cadastro" action="cadastro.php" method='POST' autocomplete="off">
                            <div class="mb-3">
                                ...
                                <input type="password" class="form-control bg-glass text-2 bs-0 input-lg" id="reg_password" name="reg_password" autocomplete="off" ng-model="register_password" placeholder="Senha">
                            ...
                            <div class="mb-3 parent">
                                <input type="password" class="form-control bg-glass text-2 bs-0 input-lg" id="conf_password" name="conf_password" autocomplete="off" ng-model="confirm_password" placeholder="Confirmar senha">
