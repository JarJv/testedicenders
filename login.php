                ...
                <div class="card bg-glass text-2 mb-3 text-center" >
                    <div class="card-body">
                        ...
                        <form action="testLogin.php" method="POST">
                            <div class="mb-3">
                            <input type="text" name="usertag" class="form-control bg-glass text-2 bs-0" id="InputEmail1" aria-describedby="emailHelp" placeholder="Nome de usuário">
                            </div>
                            <div class="mb-3">
                            <input type="password" name="senha" class="form-control bg-glass text-2 bs-0" id="InputPassword1" placeholder="Senha">
                            </div>
